...
<body>
  ...
  <div class="content">
    ...
    <div style="background:#fff8e1;border:2px solid #f6c644;border-radius:8px;padding:12px 16px;margin:0 0 16px;color:#b45309;font-weight:bold;font-size:14px;">
      ⚠️ Nachtbuchung – Kunde wurde gebeten, sicherheitshalber telefonisch zu bestätigen.
    </div>` : ''}
    ...
    <div class="section">
      ...
      <div class="row"><span class="label">Telefon:</span><span class="value"><a href="tel:${booking.phone}">${formatPhoneDisplay(booking.phone)}</a></span></div>
