  ...
  en: {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          { question: 'How much does a van from Munich Airport to the city center cost?', answer: 'Our system calculates the fixed price for a van (Mercedes Viano, 4–7 passengers) from Munich Airport to the city center instantly on our website. A van offers space for up to 7 people with plenty of luggage and is the most cost-effective choice for groups of 4 or more – everyone travels together in one vehicle.' },
          { question: 'What is cheaper: 2 taxis or 1 van from Munich Airport?', answer: 'For groups of 4 or more, a van is almost always the more economical choice: instead of booking two separate vehicles, everyone travels together in one van for up to 7 passengers – with just one fixed price, one driver and no coordination. You see the exact price comparison instantly when booking on our website.' },
      ...
      },
      {
        ...
        items: [
          ...
          { question: 'Taxi from Munich Airport to Hauptbahnhof – price and duration?', answer: 'Our system calculates the fixed price for your transfer from Munich Airport to Munich Hauptbahnhof (main train station) instantly on our website (depending on vehicle). The journey takes approximately 35–50 minutes via the A9, depending on traffic. Your driver waits in the arrivals area with a name sign – no taxi rank, no queue.' },
          { question: 'How much does a taxi from Munich Airport to Schwabing or Maxvorstadt cost?', answer: 'Our system calculates the fixed price for your transfer from Munich Airport to Schwabing or Maxvorstadt instantly and transparently on our website. The journey takes approximately 30–45 minutes depending on traffic.' },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { question: 'Münih Havalimanı\'ndan şehir merkezine taksi ne kadar tutar?', answer: 'Münih Havalimanı\'ndan şehir merkezine (ör. Hauptbahnhof veya Marienplatz) transferinizin sabit fiyatını sistemimiz web sitemizde anında ve şeffaf şekilde hesaplar – araca ve varış adresine göre. Sabit fiyatınızı rezervasyondan önce görürsünüz; sonra sabitlenir ve değişmez: trafik zammı yok, gizli maliyet yok, sürpriz yok.' },
          { question: 'Münih\'te taksi mi yoksa özel havalimanı transferi mi daha ucuz?', answer: 'Önceden rezervasyonun en büyük avantajı planlama güvenliğidir: sabit fiyatınızı daha rezervasyon sırasında bilirsiniz – şeffaf ve bağlayıcı. Şoför sizi varış alanında isim tabelasıyla karşılar, taksi durağında kuyruk yok. Tam olarak anlaşılan fiyatı ödersiniz; gece, bagaj veya trafikte bekleme için sonradan ek ücret yok.' },
      ...
      },
      {
        ...
        items: [
          { question: 'Münih Havalimanı\'ndan şehir merkezine Van ne kadar tutar?', answer: 'Münih Havalimanı\'ndan şehir merkezine Van (Mercedes Viano, 4–7 kişi) transferinin sabit fiyatını sistemimiz web sitesinde anında hesaplar. Van, bol bagajla 7 kişiye kadar yer sunar ve 4 kişi ve üzeri gruplar için en ekonomik seçimdir – herkes tek araçta birlikte seyahat eder.' },
          { question: 'Daha ucuz olan hangisi: 2 taksi mi yoksa 1 Van mı Münih Havalimanı\'ndan?', answer: '4 kişi ve üzeri gruplar için Van neredeyse her zaman daha ekonomiktir: iki ayrı araç yerine herkes 7 kişiye kadar tek bir Van\'da birlikte seyahat eder – tek sabit fiyat, tek şoför ve koordinasyon derdi yok. Tam fiyat karşılaştırmasını rezervasyon sırasında web sitemizde anında görürsünüz.' },
          ...
          { question: 'Münih Havalimanı\'ndan ne zaman normal taksi yerine Van gerekir?', answer: '4 kişi veya daha fazla seyahat ediyorsanız, çok bagajınız varsa, çocuk arabalı aile seyahatindeyseniz veya grubun birlikte gelmesini istiyorsanız Van doğru seçimdir. 4 kişi ve üzeri için Van, neredeyse her zaman iki ayrı araçtan da daha ekonomiktir.' },
      ...
      },
      {
        ...
        items: [
          ...
          { question: 'Hangisi daha iyi: Taksi mi, S-Bahn mi, yoksa özel transfer mi?', answer: 'S-Bahn uygun fiyatlıdır, ancak çok bagajla, büyük gruplarla veya sabahın erken saatlerinde idealden uzak kalır. Taksi durağındaki taksiler esnektir ama nihai fiyat daha az öngörülebilirdir – büyük araçlar da çoğunlukla mevcut değildir. Flughafen-muenchen.TAXI en iyisini sunar: sürpriz yok sabit fiyat, isim tabelasıyla karşılama, bagaj yardımı ve kapıdan kapıya ulaşım – 7/24, aileler ve gruplar için de.' },
          ...
          { question: 'Münih Havalimanı\'ndan Hauptbahnhof\'a taksi – fiyat ve süre?', answer: 'Münih Havalimanı\'ndan Hauptbahnhof\'a (ana tren garı) transferinizin sabit fiyatını sistemimiz web sitesinde anında hesaplar (araca göre). A9 üzerinden trafiğe bağlı yaklaşık 35–50 dakika sürer. Şoförünüz varış alanında isim tabelasıyla bekler – taksi kuyruğu yok, bekleme yok.' },
          { question: 'Münih Havalimanı\'ndan Schwabing veya Maxvorstadt\'a taksi ne kadar?', answer: 'Münih Havalimanı\'ndan Schwabing veya Maxvorstadt\'a transferinizin sabit fiyatını sistemimiz web sitesinde anında ve şeffaf şekilde hesaplar. Trafiğe bağlı olarak yaklaşık 30–45 dakika sürer.' },
