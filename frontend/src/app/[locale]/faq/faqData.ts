    ...
    categories: [
      {
        ...
        items: [
          ...
          { question: 'Was ist günstiger: Taxi oder privater Flughafentransfer in München?', answer: 'Ein von uns vorgebuchter Transfer ist in der Regel günstiger als ein normales Taxameter-Taxi vom Stand. Wer über unsere Website vorbucht, spart bis zu 30 % gegenüber einem Taxi vom Stand. Normale Taxis berechnen den Tarif nach Uhr und Kilometern – dazu kommen Zuschläge für Nacht, Gepäck oder Wartezeit. Bei uns zahlen Sie einen fixen Preis ab 88 € zum Stadtzentrum, der bereits bei der Buchung feststeht. Kein Taktieren, kein Nachzahlen.' },
      ...
      },
      {
        ...
        items: [
          { question: 'Wie viel kostet ein Van vom Flughafen München ins Stadtzentrum?', answer: 'Ein Van (Mercedes Viano, 4–7 Personen) vom Flughafen München ins Münchner Stadtzentrum kostet ab 95 €. Das sind nur 7 € mehr als ein Kombi für 1–3 Personen – und der Van bietet Platz für bis zu 7 Personen mit reichlich Gepäck. Die wirtschaftlichste Wahl für Gruppen ab 4 Personen.' },
          { question: 'Was ist günstiger: 2 Taxis oder 1 Van vom Flughafen München?', answer: 'Für Gruppen ab 4 Personen ist ein Van fast immer die günstigere Wahl. Beispiel: Zwei Kombis ins Stadtzentrum kosten je 88 € = 176 € gesamt. Ein Van für bis zu 7 Personen kostet dagegen nur 95 € – das sind über 80 € Ersparnis. Dazu kommt: alle fahren zusammen, ein Fahrer, keine Koordination nötig.' },
      ...
      },
      {
        ...
        items: [
          ...
          { question: 'Was ist besser: Taxi, S-Bahn oder privater Transfer vom Flughafen München?', answer: 'Die S-Bahn ist preisgünstig, aber nicht ideal bei viel Gepäck, großen Gruppen oder frühmorgendlichen Ankünften. Normale Taxis am Stand sind flexibel, aber teurer durch Taxameter und Zuschläge – und Großraumfahrzeuge sind oft nicht verfügbar. Flughafen-muenchen.TAXI bietet das Beste: fixer Preis ohne Überraschungen, persönlicher Empfang mit Namensschild, Gepäckshilfe und direkter Transport bis vor die Tür – 24/7, auch für Familien und Gruppen.' },
          ...
          { question: 'Taxi vom Flughafen München zum Hauptbahnhof – Preis und Dauer?', answer: 'Ein Festpreis-Transfer vom Flughafen München zum Münchner Hauptbahnhof kostet ab 88 € (Kombi, 1–3 Personen) oder ab 95 € (Van, 4–7 Personen). Die Fahrt dauert je nach Verkehr ca. 35–50 Minuten über die A9. Ihr Fahrer wartet im Ankunftsbereich mit einem Namensschild – kein Taxistand, keine Warteschlange.' },
          { question: 'Wie viel kostet ein Taxi vom Flughafen München nach Schwabing oder Maxvorstadt?', answer: 'Ein Festpreis-Transfer vom Flughafen München nach Schwabing oder Maxvorstadt kostet ab 82 € (Kombi, 1–3 Personen) oder ab 87 € (Van, 4–7 Personen). Die Fahrt dauert je nach Verkehr ca. 30–45 Minuten.' },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { question: 'How much does a taxi from Munich Airport to the city center cost?', answer: 'With our fixed-price service, a transfer from Munich Airport to Munich city center (e.g. Hauptbahnhof or Marienplatz) starts at €88 for a sedan (1–3 passengers) and €95 for a van (4–7 passengers). The price is confirmed before booking and does not change – no taximeter, no traffic surcharges, no surprises.' },
          { question: 'What is cheaper: taxi or private airport transfer in Munich?', answer: 'A transfer pre-booked through us is generally cheaper than a regular metered taxi from the rank. Booking via our website saves you up to 30% compared to a taxi from the stand. Regular taxis charge by meter and distance – with additional surcharges for night, luggage or waiting time. With us you pay a fixed price from €88 to the city centre, confirmed at the time of booking. No surprises, no extra charges.' },
